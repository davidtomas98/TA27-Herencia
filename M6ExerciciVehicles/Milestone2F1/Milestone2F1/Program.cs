...
namespace Milestone2F1
{
    ...
    class Program
    {
        static void Main(string[] args)
        {
            ...
            // Demanar al tipus de vehicle a l'usuari
            Console.Write("Vols crear un cotxe (C), una moto (M) o un camió (T)? ");
            ...
            else if (opcio == 'T' || opcio == 't')
            {
                vehicle = new Camió(matricula, marca, color);

                ((Camió)vehicle).AfegirRodesCamió();
            }
            else
            {
